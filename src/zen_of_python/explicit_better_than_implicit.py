...
print("The above code will take any function \n"
...
def add_explicit(a:int, b:int) -> int:
    return a + b
print("The above is better for typehinting to ensure developer\n"
      "know what inputs are expected")
print(add_explicit(1,2))
print("we can try to add a string below and it would" 
